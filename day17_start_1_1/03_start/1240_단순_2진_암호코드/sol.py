...
#
#             if cnt % 2 != 0:
#                 odd += pw_pattern[pattern]
#             else:
#                 even += pw_pattern[pattern]
#             cnt += 1
#             i += 7
#         else:
#             i += 1
...
#
#     # while i < len(pw_line):
#     #     if pw_line[i: i + 7] in pw_pattern.keys():
#     #         pattern = pw_line[i: i + 7]
#     #
...
#     result = (odd * 3) + even
#
#     print(f'#{t}', result if result % 10 == 0 else 0)
